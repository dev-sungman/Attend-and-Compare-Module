...
__all__ = ['ResNet', 'resnet18', 'resnet34', 'acm_resnet50', 'resnet101',
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, groups=1,
        ...
        self.acm = ACMBlock(planes * self.expansion)
...
class ResNet(nn.Module):
    ...
    def _resize_tensor(self, tensor):
        out = F.interpolate(tensor, (16,16))
        return out
...
def acm_resnet50(pretrained=False, progress=True, **kwargs):
